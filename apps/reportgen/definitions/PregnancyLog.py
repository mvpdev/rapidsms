...
class ReportDefinition(PrintedReport):
    ...
    def _create_table(self):
        ...
        table.add_header_row([
            ...
            Text(_(u'Age')),
            Text(_(u'HOH')),
            Text(_(u'Month of Gestation')),
            Text(_(u'Expected Date of Delivery')),
    ...
    def _add_report_to_table(self, table, report):
        ...
        table.add_row([
            ...
            Text(report.pregnancy_month),
            Text(report.estimated_dd().strftime("%d/%m/%y")),
