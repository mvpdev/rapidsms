...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Slide', fields ['number']
        db.delete_unique('findtb_slide', ['number'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Slide', fields ['number']
        db.create_unique('findtb_slide', ['number'])
