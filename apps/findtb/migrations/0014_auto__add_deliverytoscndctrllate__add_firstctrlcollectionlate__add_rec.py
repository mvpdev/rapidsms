...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DeliveryToScndCtrlLate'
        db.create_table('findtb_deliverytoscndctrllate', (
            ('collectedfrom1stctrl_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['findtb.CollectedFrom1stCtrl'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('findtb', ['DeliveryToScndCtrlLate'])

        # Adding model 'FirstCtrlCollectionLate'
        db.create_table('findtb_firstctrlcollectionlate', (
            ('passedfirstcontrol_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['findtb.PassedFirstControl'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('findtb', ['FirstCtrlCollectionLate'])

        # Adding model 'ReceivedByDtuLate'
        db.create_table('findtb_receivedbydtulate', (
            ('readytoleaventrl_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['findtb.ReadyToLeaveNtrl'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('findtb', ['ReceivedByDtuLate'])

        # Adding model 'SecondCtrlTestingLate'
        db.create_table('findtb_secondctrltestinglate', (
            ('deliveredto2ndctrl_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['findtb.DeliveredTo2ndCtrl'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('findtb', ['SecondCtrlTestingLate'])

        # Adding model 'SecondCtrlReportLate'
        db.create_table('findtb_secondctrlreportlate', (
            ('resultsavailable_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['findtb.ResultsAvailable'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('findtb', ['SecondCtrlReportLate'])

        # Adding model 'FirstCtrlTestingLate'
        db.create_table('findtb_firstctrltestinglate', (
        ...
        db.send_create_signal('findtb', ['FirstCtrlTestingLate'])


    def backwards(self, orm):
        
        # Deleting model 'DeliveryToScndCtrlLate'
        db.delete_table('findtb_deliverytoscndctrllate')

        # Deleting model 'FirstCtrlCollectionLate'
        db.delete_table('findtb_firstctrlcollectionlate')

        # Deleting model 'ReceivedByDtuLate'
        db.delete_table('findtb_receivedbydtulate')

        # Deleting model 'SecondCtrlTestingLate'
        db.delete_table('findtb_secondctrltestinglate')

        # Deleting model 'SecondCtrlReportLate'
        db.delete_table('findtb_secondctrlreportlate')

        # Deleting model 'FirstCtrlTestingLate'
        db.delete_table('findtb_firstctrltestinglate')
    ...
    models = {
        ...
        'findtb.collectedfrom1stctrl': {
            'Meta': {'object_name': 'CollectedFrom1stCtrl', '_ormbases': ['findtb.Eqa']},
            'eqa_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['findtb.Eqa']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'findtb.deliveredto2ndctrl': {
            'Meta': {'object_name': 'DeliveredTo2ndCtrl', '_ormbases': ['findtb.Eqa']},
            'eqa_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['findtb.Eqa']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'findtb.deliverytoscndctrllate': {
            'Meta': {'object_name': 'DeliveryToScndCtrlLate', '_ormbases': ['findtb.CollectedFrom1stCtrl']},
            'collectedfrom1stctrl_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['findtb.CollectedFrom1stCtrl']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'findtb.firstctrlcollectionlate': {
            'Meta': {'object_name': 'FirstCtrlCollectionLate', '_ormbases': ['findtb.PassedFirstControl']},
        ...
        'findtb.firstctrltestinglate': {
            'Meta': {'object_name': 'FirstCtrlTestingLate', '_ormbases': ['findtb.DeliveredTo1stCtrler']},
        ...
        'findtb.receivedbydtulate': {
            'Meta': {'object_name': 'ReceivedByDtuLate', '_ormbases': ['findtb.ReadyToLeaveNtrl']},
            'readytoleaventrl_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['findtb.ReadyToLeaveNtrl']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'findtb.secondctrlreportlate': {
            'Meta': {'object_name': 'SecondCtrlReportLate', '_ormbases': ['findtb.ResultsAvailable']},
            'resultsavailable_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['findtb.ResultsAvailable']", 'unique': 'True', 'primary_key': 'True'})
        },
        'findtb.secondctrltestinglate': {
            'Meta': {'object_name': 'SecondCtrlTestingLate', '_ormbases': ['findtb.DeliveredTo2ndCtrl']},
            'deliveredto2ndctrl_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['findtb.DeliveredTo2ndCtrl']", 'unique': 'True', 'primary_key': 'True'})
        },
        'findtb.sirezresult': {
