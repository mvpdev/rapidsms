...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'DeliveryIsOverdue'
        db.delete_table('findtb_deliveryisoverdue')

        # Adding model 'SendingIsLate'
        db.create_table('findtb_sendingislate', (
    ...
    def backwards(self, orm):
        ...
        # Adding model 'DeliveryIsOverdue'
        db.create_table('findtb_deliveryisoverdue', (
            ('specimensent_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['findtb.SpecimenSent'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('findtb', ['DeliveryIsOverdue'])
