...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LpaIsLate'
        db.create_table('findtb_lpaislate', (
            ('microscopyresult_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['findtb.MicroscopyResult'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('findtb', ['LpaIsLate'])

        # Adding model 'MgitIsLate'
        db.create_table('findtb_mgitislate', (
            ('microscopyresult_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['findtb.MicroscopyResult'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('findtb', ['MgitIsLate'])


    def backwards(self, orm):
        
        # Deleting model 'LpaIsLate'
        db.delete_table('findtb_lpaislate')

        # Deleting model 'MgitIsLate'
        db.delete_table('findtb_mgitislate')
    ...
    models = {
        ...
        'findtb.lpaislate': {
            'Meta': {'object_name': 'LpaIsLate', '_ormbases': ['findtb.MicroscopyResult']},
            'microscopyresult_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['findtb.MicroscopyResult']", 'unique': 'True', 'primary_key': 'True'})
        },
        'findtb.lparesult': {
        ...
        'findtb.mgitislate': {
            'Meta': {'object_name': 'MgitIsLate', '_ormbases': ['findtb.MicroscopyResult']},
            'microscopyresult_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['findtb.MicroscopyResult']", 'unique': 'True', 'primary_key': 'True'})
        },
        'findtb.mgitresult': {
