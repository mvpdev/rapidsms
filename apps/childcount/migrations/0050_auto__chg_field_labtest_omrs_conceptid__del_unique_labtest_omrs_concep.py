...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'LabTest', fields ['omrs_conceptid']
        db.delete_unique('cc_labtest', ['omrs_conceptid'])

        # Changing field 'LabTest.omrs_conceptid'
        db.alter_column('cc_labtest', 'omrs_conceptid', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'LabTestResults.ref_range'
        db.alter_column('cc_labtestresults', 'ref_range', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'LabTestResults.result_type'
        db.alter_column('cc_labtestresults', 'result_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'LabTestResults.omrs_conceptid'
        db.alter_column('cc_labtestresults', 'omrs_conceptid', self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True))

        # Changing field 'LabTestResults.units'
        db.alter_column('cc_labtestresults', 'units', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'LabTest.omrs_conceptid'
        db.alter_column('cc_labtest', 'omrs_conceptid', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True))

        # Adding unique constraint on 'LabTest', fields ['omrs_conceptid']
        db.create_unique('cc_labtest', ['omrs_conceptid'])

        # Changing field 'LabTestResults.ref_range'
        db.alter_column('cc_labtestresults', 'ref_range', self.gf('django.db.models.fields.CharField')(default='', max_length=4))

        # Changing field 'LabTestResults.result_type'
        db.alter_column('cc_labtestresults', 'result_type', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'LabTestResults.omrs_conceptid'
        db.alter_column('cc_labtestresults', 'omrs_conceptid', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'LabTestResults.units'
        db.alter_column('cc_labtestresults', 'units', self.gf('django.db.models.fields.CharField')(default='', max_length=4))
