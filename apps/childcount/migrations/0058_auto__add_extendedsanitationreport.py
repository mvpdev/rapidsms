...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExtendedSanitationReport'
        db.create_table('cc_extsanitation_rpt', (
            ('sanitationreport_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['childcount.SanitationReport'], unique=True, primary_key=True)),
            ('handwash_facility', self.gf('django.db.models.fields.CharField')(default='U', max_length=1)),
            ('wash_handwith', self.gf('django.db.models.fields.CharField')(default='OWR', max_length=4)),
            ('shower', self.gf('django.db.models.fields.CharField')(default='U', max_length=4)),
        ))
        db.send_create_signal('childcount', ['ExtendedSanitationReport'])


    def backwards(self, orm):
        
        # Deleting model 'ExtendedSanitationReport'
        db.delete_table('cc_extsanitation_rpt')
    ...
    models = {
        ...
        'childcount.extendedsanitationreport': {
            'Meta': {'object_name': 'ExtendedSanitationReport', 'db_table': "'cc_extsanitation_rpt'", '_ormbases': ['childcount.SanitationReport']},
            'handwash_facility': ('django.db.models.fields.CharField', [], {'default': "'U'", 'max_length': '1'}),
            'sanitationreport_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['childcount.SanitationReport']", 'unique': 'True', 'primary_key': 'True'}),
            'shower': ('django.db.models.fields.CharField', [], {'default': "'U'", 'max_length': '4'}),
            'wash_handwith': ('django.db.models.fields.CharField', [], {'default': "'OWR'", 'max_length': '4'})
        },
        ...
        'childcount.labresultsreport': {
            'Meta': {'object_name': 'LabResultsReport', 'db_table': "'cc_labresults'", '_ormbases': ['childcount.CCReport']},
            'ccreport_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['childcount.CCReport']", 'unique': 'True', 'primary_key': 'True'}),
            'labtest': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['childcount.LabReport']"}),
            'results': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'})
        },
        'childcount.labtest': {
        ...
        'childcount.omrserrorlog': {
            'Meta': {'object_name': 'OMRSErrorLog', 'db_table': "'cc_omrserror'"},
            'encounter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['childcount.Encounter']"}),
            'error_message': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'error_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'childcount.patient': {
        ...
        'childcount.schoolattendancereport': {
            ...
            'ccreport_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['childcount.CCReport']", 'unique': 'True', 'primary_key': 'True'}),
            'household_pupil': ('django.db.models.fields.SmallIntegerField', [], {'default': '0', 'db_index': 'True'})
        },
