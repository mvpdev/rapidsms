...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BednetUtilizationPregnancy'
        db.create_table('cc_bdnutilpreg_rpt', (
            ...
            ('slept_lastnite', self.gf('django.db.models.fields.PositiveSmallIntegerField')(db_index=True)),
            ('slept_underbednet', self.gf('django.db.models.fields.PositiveSmallIntegerField')(db_index=True)),
        ))
        db.send_create_signal('childcount', ['BednetUtilizationPregnancy'])
        ...
        # Adding field 'BedNetReport.function_nets_observed'
        db.add_column('cc_bnrpt', 'function_nets_observed', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'BednetUtilizationPregnancy'
        db.delete_table('cc_bdnutilpreg_rpt')

        # Adding field 'BednetUtilization.reason'
        db.add_column('cc_bdnutil_rpt', 'reason', self.gf('django.db.models.fields.CharField')(blank=True, max_length=2, null=True, db_index=True), keep_default=False)

        # Adding field 'BednetUtilization.hanging_bednet'
        db.add_column('cc_bdnutil_rpt', 'hanging_bednet', self.gf('django.db.models.fields.SmallIntegerField')(blank=True, null=True, db_index=True), keep_default=False)

        # Adding field 'BedNetReport.damaged_nets'
        db.add_column('cc_bnrpt', 'damaged_nets', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'BedNetReport.earlier_nets'
        db.add_column('cc_bnrpt', 'earlier_nets', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True), keep_default=False)

        # Deleting field 'BedNetReport.function_nets_observed'
        db.delete_column('cc_bnrpt', 'function_nets_observed')
