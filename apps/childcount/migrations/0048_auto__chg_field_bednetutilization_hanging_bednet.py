...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cc_bdnutil_rpt', 'hanging_bednet', self.gf('django.db.models.fields.SmallIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'BednetUtilization.hanging_bednet'
        db.alter_column('cc_bdnutil_rpt', 'hanging_bednet', self.gf('django.db.models.fields.SmallIntegerField')(default=0))
    ...
    models = {
        ...
        'childcount.bednetutilization': {
            ...
            'hanging_bednet': ('django.db.models.fields.SmallIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
