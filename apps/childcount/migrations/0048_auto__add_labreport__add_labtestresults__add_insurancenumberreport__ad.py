...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LabReport'
        db.create_table('cc_labreport', (
            ...
            ('lab_test', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.LabTest'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='IC', max_length=4)),
            ('sample_no', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30, blank=True)),
            ('progress_status', self.gf('django.db.models.fields.CharField')(default='', max_length=2)),
            ('results', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('omrs_conceptid', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('childcount', ['LabReport'])

        # Adding model 'LabTestResults'
        db.create_table('cc_labtestresults', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('test', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.LabTest'])),
            ('result_type', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('units', self.gf('django.db.models.fields.CharField')(max_length=4, blank=True)),
            ('ref_range', self.gf('django.db.models.fields.CharField')(max_length=4, blank=True)),
            ('omrs_conceptid', self.gf('django.db.models.fields.IntegerField')(blank=True)),
        ))
        db.send_create_signal('childcount', ['LabTestResults'])

        # Adding model 'InsuranceNumberReport'
        db.create_table('cc_insrpt', (
            ('ccreport_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['childcount.CCReport'], unique=True, primary_key=True)),
            ('insurance_no', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
        ))
        db.send_create_signal('childcount', ['InsuranceNumberReport'])

        # Adding model 'LabTest'
        db.create_table('cc_labtest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ('defined_results', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('omrs_conceptid', self.gf('django.db.models.fields.IntegerField')(unique=True, blank=True)),
        ))
        db.send_create_signal('childcount', ['LabTest'])

        # Adding model 'SpecimenReport'
        db.create_table('cc_specimenrpt', (
            ('ccreport_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['childcount.CCReport'], unique=True, primary_key=True)),
            ('blood_tubes', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('sputum_sample', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('stool_sample', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('urine_sample', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal('childcount', ['SpecimenReport'])


    def backwards(self, orm):
        
        # Deleting model 'LabReport'
        db.delete_table('cc_labreport')

        # Deleting model 'LabTestResults'
        db.delete_table('cc_labtestresults')

        # Deleting model 'InsuranceNumberReport'
        db.delete_table('cc_insrpt')

        # Deleting model 'LabTest'
        db.delete_table('cc_labtest')

        # Deleting model 'SpecimenReport'
        db.delete_table('cc_specimenrpt')
    ...
    models = {
        ...
        'childcount.labreport': {
            ...
            'omrs_conceptid': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'progress_status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2'}),
        ...
        'childcount.labtest': {
            ...
            'omrs_conceptid': ('django.db.models.fields.IntegerField', [], {'unique': 'True', 'blank': 'True'})
        },
        'childcount.labtestresults': {
            'Meta': {'object_name': 'LabTestResults', 'db_table': "'cc_labtestresults'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'omrs_conceptid': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'ref_range': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'result_type': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'test': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['childcount.LabTest']"}),
            'units': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'})
        },
