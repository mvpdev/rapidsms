...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LabResultsReport'
        db.create_table('cc_labresults', (
            ...
            ('labtest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.LabReport'])),
            ('results', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
        ))
        db.send_create_signal('childcount', ['LabResultsReport'])

        # Deleting field 'LabReport.results'
        db.delete_column('cc_labreport', 'results')


    def backwards(self, orm):
        
        # Deleting model 'LabResultsReport'
        db.delete_table('cc_labresults')

        # Adding field 'LabReport.results'
        db.add_column('cc_labreport', 'results', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)
