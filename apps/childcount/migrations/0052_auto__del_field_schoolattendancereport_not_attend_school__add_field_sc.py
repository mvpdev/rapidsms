...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SchoolAttendanceReport.not_attend_school'
        db.delete_column('cc_schoolattendance', 'not_attend_school')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SchoolAttendanceReport.not_attend_school'
        db.add_column('cc_schoolattendance', 'not_attend_school', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True), keep_default=False)
