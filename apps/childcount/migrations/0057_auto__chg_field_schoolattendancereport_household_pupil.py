...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SchoolAttendanceReport.household_pupil'
        db.alter_column('cc_schoolattendance', 'household_pupil', self.gf('django.db.models.fields.SmallIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'SchoolAttendanceReport.household_pupil'
        db.alter_column('cc_schoolattendance', 'household_pupil', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
