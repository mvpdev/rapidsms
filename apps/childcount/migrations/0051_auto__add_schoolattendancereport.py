...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SchoolAttendanceReport'
        db.create_table('cc_schoolattendance', (
            ...
            ('household_pupil', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True)),
            ('attending_school', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True)),
            ('not_attend_school', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True)),
            ('school_type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, db_index=True)),
        ))
        db.send_create_signal('childcount', ['SchoolAttendanceReport'])

        # Adding M2M table for field reason on 'SchoolAttendanceReport'
        db.create_table('cc_schoolattendance_reason', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('schoolattendancereport', models.ForeignKey(orm['childcount.schoolattendancereport'], null=False)),
            ('codeditem', models.ForeignKey(orm['childcount.codeditem'], null=False))
        ))
        db.create_unique('cc_schoolattendance_reason', ['schoolattendancereport_id', 'codeditem_id'])


    def backwards(self, orm):
        
        # Deleting model 'SchoolAttendanceReport'
        db.delete_table('cc_schoolattendance')

        # Removing M2M table for field reason on 'SchoolAttendanceReport'
        db.delete_table('cc_schoolattendance_reason')
    ...
    models = {
        ...
        'childcount.schoolattendancereport': {
            ...
            'not_attend_school': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'reason': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['childcount.CodedItem']", 'null': 'True', 'blank': 'True'}),
