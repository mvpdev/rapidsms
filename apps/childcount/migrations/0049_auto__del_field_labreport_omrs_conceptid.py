...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LabReport.omrs_conceptid'
        db.delete_column('cc_labreport', 'omrs_conceptid')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'LabReport.omrs_conceptid'
        raise RuntimeError("Cannot reverse this migration. 'LabReport.omrs_conceptid' and its values cannot be restored.")
