...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SchoolAttendanceReport.school_type'
        db.delete_column('cc_schoolattendance', 'school_type')

        # Deleting field 'SchoolAttendanceReport.attendschool_other'
        db.delete_column('cc_schoolattendance', 'attendschool_other')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SchoolAttendanceReport.school_type'
        db.add_column('cc_schoolattendance', 'school_type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, db_index=True), keep_default=False)

        # Adding field 'SchoolAttendanceReport.attendschool_other'
        db.add_column('cc_schoolattendance', 'attendschool_other', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True), keep_default=False)
