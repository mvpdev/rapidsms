...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OMRSErrorLog'
        db.create_table('cc_omrserror', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('encounter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.Encounter'])),
            ('error_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('error_message', self.gf('django.db.models.fields.TextField')(null=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('childcount', ['OMRSErrorLog'])


    def backwards(self, orm):
        
        # Deleting model 'OMRSErrorLog'
        db.delete_table('cc_omrserror')
